...
<template>
  <div>
    ...
    <SidebarWithNavbar @toggleSidebar="sidebarToggle" s></SidebarWithNavbar>
    <main
      :class="{
          ...
          <div class="p-4 bg-white rounded-lg md:p-8" id="pertanyaan">
            <section class="flex justify-between">
              ...
              <div class="total-score">
                <p>
                  Nilai Total: <strong>{{ totalScore.toFixed(2) }}</strong>
                </p>
              </div>
            </section>
            <section
            ...
            >
              ...
              <ul class="space-y-4 text-gray-500">
                <small class="font-semibold border border-1 p-2 italic"
                  >Indikator Poin Penilaian</small
                >
                <li
                  v-for="(item, pointIndex) in pertanyaan.point"
                  :key="item.id"
                >
                  <p class="mb-4 font-bold">
                    {{ pointIndex + 1 }}. {{ item.pointPenilaian }}
                  </p>
                  <span
                    >Skor Maksimal :
              ...
              <br />
              <small class="border- border-2 p-2 italic mt-6"
                ><span class="font-medium">Catatan:</span> Pemberian nilai bisa
                menggunakan acuan indikator yang tersedia</small
              >
              <br />
              <br />
